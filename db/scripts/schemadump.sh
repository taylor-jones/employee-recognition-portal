...
# TR: Dumps the current schema (ddl) pointed to by your env variables. Requires:
...
# Usage: ./schemadump.sh <relative path for output>
...
pg_dump -s -h $DB_HOST -p $DB_PORT -U $SPRING_DATASOURCE_USERNAME  $DB_NAME> "$schemaDirectory/$fName"
